...
export async function handleSettingsDisconnect(
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription('You are about to disconnect this server from your Creator Assistant account. This will completely stop role verification.')
...
export async function handleDisconnectWarn1(
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription('Disconnecting will **PERMANENTLY DELETE** all verification rules, download routes, and verification history for this server. Users will not lose their roles, but they will not be updated anymore.')
...
export async function handleDisconnectWarn2(
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription('This action CANNOT be undone. Are you absolutely sure you want to completely disconnect and destroy all data for this server?')
        .setColor('#FF0000'); // Red
    ...
    try {
        ...
        if (result.success) {
            const embed = new EmbedBuilder()
                ...
                .setDescription('This server has been successfully disconnected and all verification data has been permanently deleted.')
                .setColor('#00FF00');
