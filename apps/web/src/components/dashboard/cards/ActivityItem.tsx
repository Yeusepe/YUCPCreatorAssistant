...
const DEFAULT_VISUALS = {
  icon: () => <DotIcon />,
  colorClasses: 'text-zinc-500 dark:text-zinc-400',
  bgClasses: 'bg-zinc-100 dark:bg-zinc-800/80',
};
...
export function ActivityItem({
  ...
  return (
    <div className={['dash-activity-entry', className].filter(Boolean).join(' ')}>
      <article className="dash-activity-entry__card">
        <div className="dash-activity-entry__card-inner">
          <div
            className={[
          ...
          <div className="dash-activity-entry__text">
            <p className="dash-activity-entry__desc">{description}</p>
            <time
              className="dash-activity-entry__time"
