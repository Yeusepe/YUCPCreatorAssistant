                  ...
                  <div className="mockup-col mockup-shell">
                    ...
                    <div className="ph-body">
                      ...
                      <div className="ph-main">
                        ...
                        <div
                          className="ph-card dimmed"
                          style={{ opacity: 0.14, marginTop: 'auto' }}
                        >
                  ...
                  <div className="instructions-col space-y-5">
                    ...
                    <div className="inst-card">
                      ...
                      <div className="inst-row">
                        ...
                        <p className="text-white/60 text-sm leading-relaxed">
                          Copy the <strong className="text-white">API Key</strong> shown on that
                  ...
                  <div className="instructions-col space-y-5">
                    ...
                    <div className="inst-card">
                      <div className="inst-row">
                        ...
                        <p className="text-white/60 text-sm leading-relaxed">
                          ...
                          <strong className="text-white">
                            Edit Product &rarr; Advanced Options
                          </strong>
                          . Check{' '}
                          <strong className="text-white">
                            Generate unique license keys for each sale
                      ...
                      <div className="inst-row">
                        ...
                        <p className="text-white/60 text-sm leading-relaxed">
                          The <strong className="text-white">permalink</strong> is the short code
                          from your product URL -- e.g.{' '}
